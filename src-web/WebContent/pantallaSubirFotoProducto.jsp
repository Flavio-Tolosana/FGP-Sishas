...
<body>
    ...
    <h1>Seleccione la foto del producto que desea subir:</h1>
    <form action = "SvSubirFotoProducto" method = "post" enctype="multipart/form-data">
        ...
        <div class="enviar_informacion">    
                <button type="submit" id="boton-vender" name="subirFoto" value="<%=request.getAttribute("idProducto")%>">Subir foto del producto</button>       
        </div>
    </form>
</body>
</html>