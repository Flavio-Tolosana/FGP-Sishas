...
/**
 * Servlet implementation class SvEliminarProducto
...
public class SvEliminarProducto extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    // Obtener idProducto y unidades
 	 	int idProducto =  Integer.parseInt(request.getParameter("eliminar"));
 	 	dao.eliminarProducto(idProducto);

 	 	request.setAttribute("mensaje", "Se ha eliminado el producto con exito");
