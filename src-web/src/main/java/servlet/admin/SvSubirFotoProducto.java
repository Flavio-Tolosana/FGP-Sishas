...
/**
 * Servlet implementation class SvSubirFotoProducto
 */
@WebServlet("/SvSubirFotoProducto")
@MultipartConfig
public class SvSubirFotoProducto extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SvSubirFotoProducto() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("mensaje", "Producto subido con éxito");
